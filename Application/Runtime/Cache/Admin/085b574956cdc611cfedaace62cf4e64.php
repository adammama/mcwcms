...
<head>
    ...
    <!-- bootstrap - css -->
<link href="/mcwcms/Public/BJUI/themes/css/bootstrap.css" rel="stylesheet">
<!-- core - css -->
<link href="/mcwcms/Public/BJUI/themes/css/style.css" rel="stylesheet">
<link href="/mcwcms/Public/BJUI/themes/blue/core.css" id="/mcwcms/Public/BJUI-link-theme" rel="stylesheet">
<!-- plug - css -->
<link href="/mcwcms/Public/BJUI/plugins/kindeditor_4.1.10/themes/default/default.css" rel="stylesheet">
<link href="/mcwcms/Public/BJUI/plugins/colorpicker/css/bootstrap-colorpicker.min.css" rel="stylesheet">
<link href="/mcwcms/Public/BJUI/plugins/niceValidator/jquery.validator.css" rel="stylesheet">
<link href="/mcwcms/Public/BJUI/plugins/bootstrapSelect/bootstrap-select.css" rel="stylesheet">
<link href="/mcwcms/Public/BJUI/themes/css/FA/css/font-awesome.min.css" rel="stylesheet">
<!--[if lte IE 7]>
<link href="/mcwcms/Public/BJUI/themes/css/ie7.css" rel="stylesheet">
<![endif]-->
<!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
<!--[if lte IE 9]>
<script src="/mcwcms/Public/BJUI/other/html5shiv.min.js"></script>
<script src="/mcwcms/Public/BJUI/other/respond.min.js"></script>
<![endif]-->
<!-- jquery -->
<script src="/mcwcms/Public/BJUI/js/jquery-1.11.3.min.js"></script>
<script src="/mcwcms/Public/BJUI/js/jquery.cookie.js"></script>
<!--[if lte IE 9]>
<script src="/mcwcms/Public/BJUI/other/jquery.iframe-transport.js"></script>
<![endif]-->
<!-- BJUI.all 分模块压缩版 -->
<script src="/mcwcms/Public/BJUI/js/bjui-all.js"></script>
<!-- 以下是B-JUI的分模块未压缩版，建议开发调试阶段使用下面的版本 -->
<!--
<script src="/mcwcms/Public/BJUI/js/bjui-core.js"></script>
...
<script src="/mcwcms/Public/BJUI/plugins/swfupload/swfupload.js"></script>
<!-- kindeditor -->
<script src="/mcwcms/Public/BJUI/plugins/kindeditor_4.1.10/kindeditor-all.min.js"></script>
<script src="/mcwcms/Public/BJUI/plugins/kindeditor_4.1.10/lang/zh_CN.js"></script>
<!-- colorpicker -->
<script src="/mcwcms/Public/BJUI/plugins/colorpicker/js/bootstrap-colorpicker.min.js"></script>
<!-- ztree -->
<script src="/mcwcms/Public/BJUI/plugins/ztree/jquery.ztree.all-3.5.js"></script>
<!-- nice validate -->
<script src="/mcwcms/Public/BJUI/plugins/niceValidator/jquery.validator.js"></script>
<script src="/mcwcms/Public/BJUI/plugins/niceValidator/jquery.validator.themes.js"></script>
<!-- bootstrap plugins -->
<script src="/mcwcms/Public/BJUI/plugins/bootstrap.min.js"></script>
<script src="/mcwcms/Public/BJUI/plugins/bootstrapSelect/bootstrap-select.min.js"></script>
<script src="/mcwcms/Public/BJUI/plugins/bootstrapSelect/defaults-zh_CN.min.js"></script>
<!-- icheck -->
<script src="/mcwcms/Public/BJUI/plugins/icheck/icheck.min.js"></script>
<!-- dragsort -->
<script src="/mcwcms/Public/BJUI/plugins/dragsort/jquery.dragsort-0.5.1.min.js"></script>
<!-- HighCharts -->
<script src="/mcwcms/Public/BJUI/plugins/highcharts/highcharts.js"></script>
<script src="/mcwcms/Public/BJUI/plugins/highcharts/highcharts-3d.js"></script>
<script src="/mcwcms/Public/BJUI/plugins/highcharts/themes/gray.js"></script>
<!-- ECharts -->
<script src="/mcwcms/Public/BJUI/plugins/echarts/echarts.js"></script>
<!-- other plugins -->
<script src="/mcwcms/Public/BJUI/plugins/other/jquery.autosize.js"></script>
<link href="/mcwcms/Public/BJUI/plugins/uploadify/css/uploadify.css" rel="stylesheet">
<script src="/mcwcms/Public/BJUI/plugins/uploadify/scripts/jquery.uploadify.min.js"></script>
<script src="/mcwcms/Public/BJUI/plugins/download/jquery.fileDownload.js"></script>
<!-- init -->
<script type="text/javascript">
    $(function() {
        BJUI.init({
            JSPATH       : '/mcwcms/Public/BJUI/',         //[可选]框架路径
            PLUGINPATH   : '/mcwcms/Public/BJUI/plugins/', //[可选]插件路径
...
<div id="bjui-window">
    <header id="bjui-header">
        <div class="bjui-navbar-header">
            ...
            <a class="bjui-navbar-logo" href="#"><img src="/mcwcms/Public/images/logo.png"></a>
        </div>
...
<!--                    <li><a href="javascript:;" data-toggle="slidebar">系统管理</a>
                        <div class="items hide" data-noinit="true">
                            <ul id="bjui-hnav-tree-input" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true" data-faicon="check-square-o" data-title="基本元素">
                                <li data-id="1" data-pid="0" data-faicon="folder-open-o" data-faicon-close="folder-o">系统管理</li>
                                <li data-id="10" data-pid="1" data-url="form-button.html" data-tabid="form-button" data-faicon="user">用户管理</li>
                                <li data-id="11" data-pid="1" data-url="form-input.html" data-tabid="form-input" data-faicon="group">角色管理</li>
                                <li data-id="12" data-pid="1" data-url="form-select.html" data-tabid="form-select" data-faicon="check-square-o">权限管理</li>
                            </ul>
                        </div>
                    </li>-->
                    <!-- zTree菜单 - END -->
        ...
        <div class="tabsPageHeader">
            <div class="tabsPageHeaderContent">
                <ul class="navtab-tab nav nav-tabs">
                    ...
                    <li data-faicon="home"><a href="javascript:;"><span><i class="fa fa-home"></i> #maintab#</span></a></li>
                </ul>
            </div>
