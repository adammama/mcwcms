...
class CommonModel extends BaseModel {
    ...
    public static function getUserFullNameByUid($uid, $type) {
        $condition['uid'] = $uid;
        $list = parent::getDetail($param = array('modelName' => 'User', 'field' => 'id,name'), $condition);
        return isset($type) ? $list['name'] : '<a href="' . U("Admin/User/detail?uid=". $list['id']) . '" data-toggle="modal" data-target="#myModal">' . $list['name'] . '</a>';
    }
